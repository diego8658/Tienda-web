...
<html>
    ...
    <header>
        ...
        <!-- Se llama a la pagina GProdPre.jsp mandandole el tipo de grafico que se quiere-->
    <center>
        <h2>Grafico de Precio por Productos</h2>
        <form action="GProdPre.jsp" target="zona">
